	...
	return (
		<Flex justify="space-between" direction="column">
			...
			<Section heading="Installation Guide">
				<Section heading="Obtaining a Bootable Usb">
				...
				<Section heading="Select Graphical Install">
				...
				<Section heading="Root Account Creation">
				...
				<Section heading="User Account Creation & Time Zone">
				...
				<Section heading="Partioning Scheme">
				...
				<Section heading="Additional Installation">
				...
				<Section heading="Debian Archive">
				...
				<Section heading="Popularity Contest">
				...
				<Section heading="Additional Software">
				...
				<Section heading="Grub Boot Loader">
					Asking to install the GRUB boot loader. This is a must, as this is
					what actually starts the OS. Once again, it will ask for a device for
